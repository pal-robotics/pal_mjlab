...
gym.register(
    id="Mjlab-Velocity-Rough-Kangaroo-Full",
...
gym.register(
    id="Mjlab-Velocity-Rough-Kangaroo-Full-Play",
    entry_point="mjlab.envs:ManagerBasedRlEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Mjlab-Velocity-Flat-Kangaroo-Full",
    entry_point="mjlab.envs:ManagerBasedRlEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Mjlab-Velocity-Flat-Kangaroo-Full-Play",
    entry_point="mjlab.envs:ManagerBasedRlEnv",
    disable_env_checker=True,
    kwargs={
