...
from .env_cfgs import (
  ...
  pal_kangaroo_easy_rough_env_cfg
)
...
register_mjlab_task(
  task_id="Mjlab-Velocity-Easy-Rough-Pal-Kangaroo",
  env_cfg=pal_kangaroo_easy_rough_env_cfg(),
  play_env_cfg=pal_kangaroo_easy_rough_env_cfg(play=True),
  rl_cfg=pal_kangaroo_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
