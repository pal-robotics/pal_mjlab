...
from .rl_cfg import pal_kangaroo_ppo_runner_cfg, pal_kangaroo_flashsac_runner_cfg
...
register_mjlab_task(
  task_id="Mjlab-Velocity-Flat-Pal-Kangaroo-FlashSAC",
  env_cfg=pal_kangaroo_flat_env_cfg(),
  play_env_cfg=pal_kangaroo_flat_env_cfg(play=True),
  rl_cfg=pal_kangaroo_flashsac_runner_cfg(),
  runner_cls=PalFlashSACRunner,
)