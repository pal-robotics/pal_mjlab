...
from pal_mjlab.tasks.registry import list_tasks, load_env_cfg, load_rl_cfg, load_runner_cls
...
from pal_mjlab.rl import RslRlFastSacRunnerCfg

@dataclass(frozen=True)
class TrainConfig:
  env: ManagerBasedRlEnvCfg
  agent: RslRlFastSacRunnerCfg
