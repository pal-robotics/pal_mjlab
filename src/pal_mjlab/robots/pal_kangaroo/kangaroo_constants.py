...
HIP_XY_CONVEX_HULL_POINTS = torch.tensor([[-0.742, 0.035], [-0.742, -0.094], [-0.742, -0.167], [-0.707, -0.243], [-0.655, -0.349], [-0.61, -0.411],
...
ANKLE_XY_CONVEX_HULL_POINTS = torch.tensor([[0.707, 0.005], [0.648, 0.112], [0.576, 0.23], [0.484, 0.38], [0.443, 0.439], [0.266, 0.443], [0.008, 0.441],
