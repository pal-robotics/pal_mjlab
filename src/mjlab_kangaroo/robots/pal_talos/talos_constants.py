...
ARM_1_ARMATURE = ARM_1_MOTOR_INERTIA * REDUCTION_RATIO ** 2
ARM_2_ARMATURE = ARM_2_MOTOR_INERTIA * REDUCTION_RATIO ** 2
ARM_34_ARMATURE = ARM_34_MOTOR_INERTIA * REDUCTION_RATIO ** 2
ARM_567_ARMATURE = ARM_567_MOTOR_INERTIA * REDUCTION_RATIO ** 2
# joints effort limit
...
# joints armature (reflected inertia)
TORSO_ARMATURE = TORSO_MOTOR_INERTIA * REDUCTION_RATIO ** 2
# joints effort limit
...
# joints armature (reflected inertia)
LEG_1_ARMATURE = LEG_16_MOTOR_INERTIA * LEG_1_REDUCTION_RATIO ** 2
LEG_2_ARMATURE = LEG_235_MOTOR_INERTIA * LEG_26_REDUCTION_RATIO ** 2
LEG_35_ARMATURE = LEG_235_MOTOR_INERTIA * REDUCTION_RATIO ** 2
LEG_4_ARMATURE = LEG_4_MOTOR_INERTIA * LEG_4_REDUCTION_RATIO ** 2
LEG_6_ARMATURE = LEG_16_MOTOR_INERTIA * LEG_26_REDUCTION_RATIO ** 2
