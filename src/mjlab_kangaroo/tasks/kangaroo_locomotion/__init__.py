...
gym.register(
  id="mjlab_kangaroo-Velocity-Rough-Unitree-Go1",
...
gym.register(
  id="mjlab_kangaroo-Velocity-Rough-Unitree-Go1-Play",
  entry_point="mjlab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
...
gym.register(
  id="mjlab_kangaroo-Velocity-Flat-Unitree-Go1",
  entry_point="mjlab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
...
gym.register(
  id="mjlab_kangaroo-Velocity-Flat-Unitree-Go1-Play",
  entry_point="mjlab.envs:ManagerBasedRlEnv",
  disable_env_checker=True,
  kwargs={
