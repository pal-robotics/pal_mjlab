...
def train():
    ...
    print(f"Resuming training for the remaining {total_iterations - unfreeze_iteration} iterations...")
    runner.learn(num_learning_iterations=total_iterations - unfreeze_iteration, init_at_random_ep_len=False)
